...
<div class="">
	...
	<div class="bg-indigo-50 shadow sm:rounded-lg ">
		<!--START:()-->
		<div class="bg-emerald-100 px-4 py-5 sm:px-6">
		...
		<div class="max-h-screen border-t border-slate-200">
			<dl class="relative">
				...
				<div
					class="bg-slate-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
				>
					<dt class="text-base font-medium text-slate-600">Date Applied</dt>
					<dd class="mt-1 text-base text-slate-900 sm:col-span-2 sm:mt-0">
						2022/11/05
					</dd>
				</div>
				...
				<div
					class="bg-indigo-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
				>
					<dt class="text-base font-medium text-slate-600">Location</dt>
					<dd class="mt-1 text-base text-slate-900 sm:col-span-2 sm:mt-0">
				...
				<div
					class="bg-indigo-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"
				>
					<dt class="text-base font-medium text-slate-600">
						Salary expectation
					</dt>
					<dd class="mt-1 text-base text-slate-900 sm:col-span-2 sm:mt-0">
						R120,000
