<script>
	...
	import Menu from '../comps/extras/Menu.svelte';
	...
	const webpages = [
		...
		// { name: 'Dash_nav', component: Dash_nav },
		// { name: 'Dash_nav_banner', component: Dash_nav_banner },
...
<!-- <div
	class="stick z-30 container px-8 py-4 col-span-6 sm:col-span-3 lg:col-span-2"
> -->
