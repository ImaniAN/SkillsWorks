		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 offset-sm-2 text-slate-50 text-center -mt-52">
					...
					<a
						href="#"
						class="text-slate-300 focus:outline-none bg-green-400 focus:ring-2 focus:ring-indigo-600 focus:text-indigo-900 focus:bg-indigo-50  hover:border-2 hover:border-dashed hover:border-indigo-600 hover:text-indigo-900 hover:bg-indigo-50 px-3 py-2 rounded-md text-sm font-medium"
					>
						Got to Home
					</a>
				</div>
