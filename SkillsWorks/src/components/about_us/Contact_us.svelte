...
<section class="text-slate-600 body-font relative w-full">
	...
	<div class="container px-5 py-24 mx-auto flex">
		...
		>
			...
			<button
				class="text-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:text-indigo-900 focus:bg-indigo-50  hover:border-2 hover:border-dashed hover:border-teal-600 hover:text-indigo-900 hover:bg-indigo-50 px-3 py-2 bg-indigo-400 rounded-md text-sm font-medium"
