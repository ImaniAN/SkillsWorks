  ...
  "
		...
		<section class="relative py-16 bg-blue-200">
			<div class="container mx-auto px-4">
				<div
					class="relative flex flex-col min-w-0 break-words bg-indigo-50 w-full mb-6 shadow-xl rounded-lg -mt-64"
				>
					<div class="px-6">
						<div class="flex flex-wrap justify-center">
							...
							>
								<div class="py-6 px-3 mt-32 sm:mt-0">
									<button
										class="bg-red-400 active:bg-red-500 uppercase text-indigo-50 font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
										type="button"
									>
										Connect
									</button>
						...
						<div class="text-center mt-12">
							<h3
								class="text-4xl font-semibold leading-normaltext-slate-700 mb-2"
							>
								Jenna Stones
							</h3>
							<div
