			...
			<div class="block w-full overflow-x-auto">
				...
				<table class="items-center w-full bg-transparent border-collapse">
					<thead>
						<tr>
							<th
								class="px-6 bg-blue-50 text-slate-500 align-middle border border-solid border-blue-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left"
							>
								Page name
							</th>
							<th
				...
				<table class="items-center w-full bg-transparent border-collapse">
					<thead class="thead-light">
						<tr>
							...
							<th
								class="px-6 bg-blue-50 text-slate-500 align-middle border border-solid border-blue-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left min-w-140-px"
							/>
						</tr>
					</thead>
					<tbody class="text-slate-500">
	...
	<div class="relative min-h-screen flex">
		...
		>
			...
			<div class="block w-full overflow-x-auto">
				<!-- Projects table -->
				<table
					class="items-center text-slate-900 w-full bg-transparent border-collapse"
				>
					<thead>
						<tr>
							<th
							...
							>
								...
								<div class="flex">
									<img
										src="https://dummyimage.com/305x305"
										alt="..."
										class="w-10 h-10 rounded-full border-2 border-blue-50 shadow"
									/>
									<img
										src="https://dummyimage.com/305x305"
										alt="..."
										class="w-10 h-10 rounded-full border-2 border-blue-50 shadow -ml-4"
									/>
									<img
										src="https://dummyimage.com/305x305"
										alt="..."
