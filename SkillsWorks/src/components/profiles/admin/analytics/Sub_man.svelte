...
<!--START:()-->
<div
	class="container mx-auto px-1 sm:px-8 max-w-4xl border-2 border-indigo-400 border-dashed w-screen"
>
	<!--START:()-->
	<div class="py-8">
		<!--START:()-->
		<div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
			<h2 class="text-2xl leading-tight text-indigo-400">Posted Jobs</h2>
			<!--START:()-->
			<div class="text-end">
				<form
				...
				>
					...
					<div class="form-control">
						<label class="label cursor-pointer">
							<span class="label-text text-indigo-400"
								>Hide filled positions</span
							>
							<input
								type="checkbox"
						...
						<tr>
							...
							>
								...
								>
									...
									/>
									<span class="relative">Needs Verfication ! </span>
								</span>
							</td>
							<td
								class="px-5 py-5 border-b border-red-300 bg-indigo-50 text-sm"
						...
						<tr>
							...
							>
								...
								>
									<span
										aria-hidden="true"
										class="absolute inset-0 bg-green-700 opacity-50 rounded-full"
									/>
									<span class="relative">Premuium Subscriber!</span>
								</span>
							</td>
							<td
								class="px-5 py-5 border-b border-red-300 bg-indigo-50 text-sm"
						...
						<tr>
							...
							>
								...
								>
									<span
										aria-hidden="true"
										class="absolute inset-0 bg-red-700 opacity-50 rounded-full"
									/>
									<span class="relative">Account Closed!</span>
								</span>
							</td>
							<td
								class="px-5 py-5 border-b border-red-300 bg-indigo-50 text-sm"
