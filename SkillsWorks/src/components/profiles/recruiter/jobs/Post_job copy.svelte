...
<script>
	...
	import Menu from '../../ui/F_Menu.svelte';
								...
								<div class="grid grid-cols-6 gap-6">
									...
									<div class="col-span-6 sm:col-span-3 lg:col-span-3">
										<label
											for="quantity"
											class="block text-sm font-medium text-slate-700"
											>Years of experiance (between 1 and 50):</label
										>
										<input
											type="number"
											id="quantity"
									...
									<div class="col-span-6 sm:col-span-3 lg:col-span-2">
										<label
											...
											class="block text-sm font-medium text-slate-700"
										>
											Renumaration (between 1 and 50):</label
										>
										<input
											type="number"
											id="quantity"
									...
									<div class="col-span-6 sm:col-span-3 lg:col-span-3">
										<label
											for="quantity"
											class="block text-sm font-medium text-slate-700"
											>NUmber of positions avaliable (between 1 and 50):</label
										>
										<input
											type="number"
											id="quantity"
							...
							<div class="grid grid-cols-6 gap-6">
								...
								<div class="col-span-6 sm:col-span-3 lg:col-span-3">
									<label
										for="quantity"
										class="block text-sm font-medium text-slate-700"
										>Min years of exp (between 1 and 50):</label
									>
									<input
										type="number"
										id="quantity"
