...
<div class="container mx-auto px-1 sm:px-8 max-w-4xl border-2 border-indigo-400 border-dashed w-screen">
	<div class="py-8">
						...
						<tr>
							...
							<td class="px-5 py-5 border-b border-red-300 bg-white text-sm">
								...
								>
									...
									/>
									<span class="relative">Position filled !</span>
								</span>
							</td>
							<td class="px-5 py-5 border-b border-red-300 bg-white text-sm">
								<!-- svelte-ignore a11y-invalid-attribute -->
						...
						<tr>
							...
							<td class="px-5 py-5 border-b border-red-300 bg-white text-sm">
								...
								>
									...
									/>
									<span class="relative">Post closed !</span>
								</span>
							</td>
							<td class="px-5 py-5 border-b border-red-300 bg-white text-sm">
								<!-- svelte-ignore a11y-invalid-attribute -->
