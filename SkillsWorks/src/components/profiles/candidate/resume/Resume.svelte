							...
							<div class="px-4 py-5 bg-indigo-50 space-y-6 sm:p-6">
								<div>
									...
									<div class="mt-1 flex items-center">
										...
										<button
											type="button"
											class="ml-5 bg-indigo-50 py-2 px-3 border-2 border-red-300 border-dashed rounded-md shadow-sm text-sm leading-4 font-medium text-slate-700 hover:bg-yellow-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
											>Change</button
										>
									</div>
									<!--END:()-->
							...
							<div class="px-4 py-5 bg-indigo-50 space-y-6 sm:p-6">
								<fieldset>
									...
									<div
										...
										aria-hidden="true"
									>
										idk man, you have a lot of things to figure out to do
									</div>
									<!--END:()-->
								...
								<div class="grid grid-cols-6 gap-6">
									...
									<div class="col-span-6 sm:col-span-3 lg:col-span-4">
										<div class="col-span-6 sm:col-span-4">
											...
											<div
												class="mt-1 flex justify-center px-6 py-20 border-2 border-red-300 border-dashed rounded-md"
											>
												<div class="space-y-1 text-center">
													<svg
											...
											<!--END:()-->
											<div
												class="mt-1 text-center flex text-indigo-400 justify-center px-1 py-1 border-2 border-red-300 border-dashed rounded-md"
											>
