<label
	for="form-alt-email-address"
	class="block text-sm font-medium text-slate-700"
	>Alternative E-mail address</label
>
<input
	type="email"
	autocomplete="email"
	id="form-alt-email-address"
	name="form-alt-email-address"
	placeholder="Your e-mail address (example@email.com)"
