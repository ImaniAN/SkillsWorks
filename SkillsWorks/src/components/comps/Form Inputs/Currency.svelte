<label for="form-transaction-currency" class="block text-sm font-medium text-slate-700"
	>Renumeration currency</label
>
<select
	required
	id="form-transaction-currency"
	name="form-transaction-currency"
...
>
	...
	<option value="BAM" label="Bosnia and Herzegovina">BAM</option>
