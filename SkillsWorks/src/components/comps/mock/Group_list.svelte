	...
	>
		...
		>
			...
			>
				...
				<!-- svelte-ignore a11y-invalid-attribute -->
				<a
					class="text-indigo-50/50 p-4 inline-flex justify-center rounded-md hover:bg-slate-800 hover:text-indigo-50 smooth-hover"
					href="#"
				>
					<svg
				...
				<!-- Active: bg-slate-800 text-indigo-50, Not active: text-indigo-50/50 -->
				<!-- svelte-ignore a11y-invalid-attribute -->
				<a
					class="bg-slate-800 text-indigo-50 p-4 inline-flex justify-center rounded-md"
					href="#"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
		...
		<div class="flex-1 px-2 sm:px-0">
			...
			<div class="flex justify-between items-center">
				<h3 class="text-3xl font-extralight text-indigo-50/50">Groups</h3>
				<!--START:()-->
			...
			>
				...
				>
					...
					<!-- svelte-ignore a11y-invalid-attribute -->
					<a
						class="text-indigo-50/50 group-hover:text-indigo-50 group-hover:smooth-hover text-center"
						href="#">Create group</a
					>
				</div>
				<!--START:()-->
				...
				>
					<img
						...
						alt="cuisine"
					/>
					<h4 class="text-indigo-50 text-2xl font-bold capitalize text-center">
						Cuisine
					</h4>
					<p class="text-indigo-50/50">55 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						22 Online <span
				...
				>
					...
					<p class="text-indigo-50/50">132 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						4 Online <span
				...
				>
					...
					<p class="text-indigo-50/50">207 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						0 Online <span
							class="ml-2 w-2 h-2 block bg-red-400 rounded-full group-hover:animate-pulse"
						/>
					</p>
				</div>
				<!--START:()-->
				...
				>
					...
					<p class="text-indigo-50/50">105 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						12 Online <span
				...
				>
					...
					<p class="text-indigo-50/50">67 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						3 Online <span
				...
				>
					...
					<p class="text-indigo-50/50">83 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						43 Online <span
				...
				>
					...
					<p class="text-indigo-50/50">108 members</p>
					<p
						class="absolute top-2 text-indigo-50/20 inline-flex items-center text-xs"
					>
						86 Online <span
