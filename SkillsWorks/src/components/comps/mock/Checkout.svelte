				...
				<div class="max-w-lg px-4 mx-auto lg:px-8">
					<form class="grid grid-cols-6 gap-4">
						...
						<div class="col-span-3">
							...
							<input
								class="rounded-lg shadow-sm border-pink-300 w-full text-sm p-2.5"
								type="text"
								placeholder=""
								id="frst_name"
							/>
						...
						<fieldset class="col-span-6">
							...
							<div class="-space-y-px bg-indigo-50 rounded-lg shadow-sm">
								...
								<div>
									...
									<input
										class="border-pink-300 relative rounded-t-lg w-full focus:z-10 text-sm p-2.5 placeholder-slate-400"
										type="text"
										name="card-number"
										id="card-number"
								...
								<div class="flex -space-x-px">
									...
									<div class="flex-1">
										...
										<input
											class="border-pink-300 relative rounded-bl-lg w-full focus:z-10 text-sm p-2.5 placeholder-slate-400"
											type="text"
									...
									<div class="flex-1">
										...
										<input
											class="border-pink-300 relative rounded-br-lg w-full focus:z-10 text-sm p-2.5 placeholder-slate-400"
											type="text"
											name="card-cvc"
											id="card-cvc"
											placeholder="CVC"
						...
						<fieldset class="col-span-6">
							...
							<div class="-space-y-px bg-indigo-50 rounded-lg shadow-sm">
								...
								<div>
									...
									<select
										class="border-pink-300 relative rounded-t-lg w-full focus:z-10 text-sm p-2.5"
										id="country"
										name="country"
									>
								...
								<div>
									...
									<input
										class="border-pink-300 relative rounded-b-lg w-full focus:z-10 text-sm p-2.5 placeholder-slate-400"
										type="text"
										name="postal-code"
										id="postal-code"
