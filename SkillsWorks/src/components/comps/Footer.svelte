<footer class="bg-indigo-200">
	...
	<div class="px-4 py-16 sm:px-6 lg:px-8">
		<!--START:()-->
		<div
			class="flex flex-col items-center gap-4 p-6 bg-indigo-500 rounded-lg shadow-lg sm:flex-row sm:justify-between"
		>
			<strong class="text-xl text-slate-900 sm:text-xl">
				...
				<nav class="mt-8">
					<ul class="space-y-4 text-sm">
						<li>
							...
							<a
								class="text-slate-900 transition hover:text-amber-300/75"
								href="#"
							>
								Company History
							</a>
				...
				<nav class="mt-8">
					<ul class="space-y-4 text-sm">
						...
						<li>
							...
							>
								<span
									class="text-slate-900 transition group-hover:text-amber-300/75"
								>
									Live Chat
								</span>
		...
		<div class="mt-16">
			...
			<div class="mt-16 sm:flex sm:justify-between sm:items-center">
				...
				<div class="flex justify-center text-indigo-600 sm:justify-start">
					<img class="w-1 h-1" src="/SkillsWorkZ.svg" alt="Your Company" />
				</div>
				<!--END:()-->

				<p
					class="mt-4 text-sm text-center text-slate-900 sm:mt-0 sm:text-right"
				>
					Copyright &copy; 2069. All rights reserved. SkillsWorkZ. Powered by
					FGS
				</p>
			</div>
			<!--END:()-->
