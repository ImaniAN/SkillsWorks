...
<div class="overflow-y-scroll">
	<header class="flex items-center justify-between h-16 pl-6">
		...
		<button
			...
			class="w-16 h-16 border-l border-teal-400"
			type="button"
		>
			<svg
	...
	<nav
		class="flex flex-col text-sm font-medium text-slate-500 border-t border-b border-teal-400 divide-y divide-slate-200"
	>
