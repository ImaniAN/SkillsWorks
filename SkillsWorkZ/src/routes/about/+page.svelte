...
<div class="group inline-block">
  ...
  transition duration-150 ease-in-out origin-top min-w-32"
	>
		<li class="rounded-sm px-3 py-1 hover:bg-gray-100">Company Information</li>
		<li class="rounded-sm px-3 py-1 hover:bg-gray-100">Contact Us</li>
		<li class="rounded-sm px-3 py-1 hover:bg-gray-100">Privacy Policy</li>
		<li class="rounded-sm px-3 py-1 hover:bg-gray-100">Terms of Use</li>
	</ul>
</div>
